...
class ReplayBuffer(IterableDataset):
    ...
    def _sample_episode(self):
        # print("fns",self._episode_fns)
        eps_fn = random.choice(self._episode_fns)

        eps_idx = self._episode_fns.index(eps_fn)
        return self._episodes[eps_fn], eps_idx
    ...
    def _sample(self):
        ...
        episode, episode_idx = self._sample_episode()
        ...
        return (obs, action, reward, discount, next_obs, episode_idx)

    def __iter__(self):
        while True:
            yield self._sample()

# class ReplayBuffer_with_TrueRewards(ReplayBuffer):
